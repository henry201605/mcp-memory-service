...
This project is indexed by GitNexus as **mcp-memory-service** (17219 symbols, 36016 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/mcp-memory-service/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/mcp-memory-service/context` | Codebase overview, check index freshness |
| `gitnexus://repo/mcp-memory-service/clusters` | All functional areas |
| `gitnexus://repo/mcp-memory-service/processes` | All execution flows |
| `gitnexus://repo/mcp-memory-service/process/{name}` | Step-by-step execution trace |
